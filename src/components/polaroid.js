...
function Polaroid({index, polaroidPosition, state, polaroidData, onEnter, onLeave, onClick}) {
    ...
    return (
            ...
            <div style={state !== "normal" && state !== "hover" ? {} : {left: polaroidPosition.left + "%", top: polaroidPosition.top + "%"}} className="polaroid" data-status={state} onClick={onClick} onMouseEnter={onEnter} onMouseLeave={onLeave}>
                <div style={state !== "normal" ? {} : {transform: "rotate(" + polaroidPosition.rotation + "deg) scale(1)" }} className="polaroidcontainer">
